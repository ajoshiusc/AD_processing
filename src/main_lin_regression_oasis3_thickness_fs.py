...
def main():
    ...
    s = glob.glob(
        "/home/ajoshi/projects/AD_processing/src/outputs/oasis3_bfp_mmse_fs_th_smooth.csv"
    )
    ...
    vis_grayord_sigpval(
        pval=corr_pval,
        sig_alpha=0.05,
        surf_name="thickness_fs_smooth" + str(smth),
        out_dir="outputs",
        smooth_iter=0,
        bfp_path=BFPPATH,
        fsl_path=FSL_PATH,
    ...
    vis_grayord_sigpval(
        pval=corr_pval_fdr,
        sig_alpha=0.05,
        surf_name="thickness_fs_smooth" + str(smth) + "fdr",
        out_dir="outputs",
        smooth_iter=0,
        bfp_path=BFPPATH,
        fsl_path=FSL_PATH,
