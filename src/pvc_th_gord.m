...
function pvc_th_gord(subbasename,GOrdSurfIndFile,GOrdFile)
...
left_th=readdfs([subbasename,'.pvc-thickness_0-6mm.left.mid.cortex.dfs']);
right_th=readdfs([subbasename,'.pvc-thickness_0-6mm.right.mid.cortex.dfs']);
