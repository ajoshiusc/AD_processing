...
function pvc_iso_th_gord(subbasename,GOrdSurfIndFile,GOrdFile)
...
left_th=readdfs([subbasename,'.pvc_iso-thickness_0-6mm.left.mid.cortex.dfs']);
right_th=readdfs([subbasename,'.pvc_iso-thickness_0-6mm.right.mid.cortex.dfs']);
